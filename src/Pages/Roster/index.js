    ...
    return (
        <Grid container className={styles.gridMainContentWrapper}>
            ...
            <Grid item container xs={12} className={styles.gridContentWrapper}>
                ...
                <Slide direction="right" in={true}  unmountOnExit timeout={750} onEntered={()=>setThreeIn(true)}><div></div></Slide>
                <Slide direction="right" appear={true} in={true}  mountOnEnter unmountOnExit timeout={1000} onEntered={()=>setFourIn(true)}>
                ...
                <Slide direction="right" appear={true} in={oneIn} mountOnEnter unmountOnExit timeout={1000}>
                <Grid item container xs={12} sm={10} md={8} spacing={2} className={styles.rosterWrapper}>
                ...
                <Slide direction="right" in={twoIn} mountOnEnter unmountOnExit timeout={1000}>
                <Grid item container xs={12} sm={10} md={8} spacing={2} className={styles.rosterWrapper}>
                ...
                <Slide direction="right" in={threeIn} mountOnEnter unmountOnExit timeout={1000}>
                <Grid item container xs={12} sm={10} md={8} spacing={2} className={styles.rosterWrapper}>
                ...
                <Slide direction="right" in={fourIn} mountOnEnter unmountOnExit timeout={1000}>
                <Grid item container xs={12} sm={10} md={8} spacing={2} className={styles.rosterWrapper}>
