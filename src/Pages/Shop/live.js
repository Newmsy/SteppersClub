...
export function Shop() {
  const item1 = {
    cost: 12,
    id: "steppersTee1",
    desc: "plain white steppers tee",
    imageFrontURL: "/Assets/Images/PlaceholderShopImageFront.jpg",
    imageBackURL: "/Assets/Images/PlaceholderShopImageBack.jpg",
  };
  const item2 = {
    cost: 13,
    id: "steppersTee2",
    desc: "plain blue steppers tee",
    imageFrontURL: "/Assets/Images/PlaceholderShopImageFront.jpg",
    imageBackURL: "/Assets/Images/PlaceholderShopImageBack.jpg",
  };
  const item3 = {
  ...
  var basketItemsGrid = basket.map((IDSize, i) => (
    <Grid item container xs={12} md={8} className={styles.viewBasketGrid}>
      ...
      <Hidden smDown>
        <Grid item xs={6} md={3}>
          <img
            src={getShopItemInfo(IDSize.toString().charAt(0)).imageFrontURL}
      ...
      {!isViewingBasket && (
        ...
        >
          <Grid item xs={12} sm={6} md={4}>
            <div className={styles.shopPlaceholderItem}>placeholder_item_1</div>
            ...
            <div className={styles.shopAddToBasketButtons}>
              ...
              >
                <option value="" disabled selected={shopItem1Size === ""}>
                  Size
                </option>
                <option value="XL" selected={shopItem1Size === "XL"}>
                  XL
                </option>
                <option value="L" selected={shopItem1Size === "L"}>
                  L
                </option>
                <option value="M" selected={shopItem1Size === "M"}>
                  M
                </option>
                <option value="S" selected={shopItem1Size === "S"}>
                  S
                </option>
                <option value="XS" selected={shopItem1Size === "XS"}>
                  XS
                </option>
              </select>
              <button
                type="submit"
                onClick={() => handleAddToBasket(1, item1.cost)}
          ...
          <Grid item xs={12} sm={6} md={4}>
            <div className={styles.shopPlaceholderItem}>placeholder_item_2</div>
            ...
            <div className={styles.shopAddToBasketButtons}>
              ...
              >
                <option value="" disabled selected={shopItem2Size === ""}>
                  Size
                </option>
                <option value="XL" selected={shopItem2Size === "XL"}>
                  XL
                </option>
                <option value="L" selected={shopItem2Size === "L"}>
                  L
                </option>
                <option value="M" selected={shopItem2Size === "M"}>
                  M
                </option>
                <option value="S" selected={shopItem2Size === "S"}>
                  S
                </option>
                <option value="XS" selected={shopItem2Size === "XS"}>
                  XS
                </option>
              </select>
              <button
                type="submit"
                onClick={() => handleAddToBasket(2, item2.cost)}
          ...
          <Grid item xs={12} sm={6} md={4}>
            <div className={styles.shopPlaceholderItem}>placeholder_item_3</div>
            placeholder_item_3 £{item3.cost}
            <div className={styles.shopAddToBasketButtons}>
              <select
                name="size"
                id="size"
                onChange={(e) => setShopItem3Size(e.target.value)}
              >
                <option value="" disabled selected={shopItem3Size === ""}>
                  Size
                </option>
                <option value="XL" selected={shopItem3Size === "XL"}>
                  XL
                </option>
                <option value="L" selected={shopItem3Size === "L"}>
                  L
                </option>
                <option value="M" selected={shopItem3Size === "M"}>
                  M
                </option>
                <option value="S" selected={shopItem3Size === "S"}>
                  S
                </option>
                <option value="XS" selected={shopItem3Size === "XS"}>
                  XS
                </option>
              </select>
              <button
                type="submit"
                onClick={() => handleAddToBasket(3, item3.cost)}
                disabled={shopItem3Size === ""}
              >
                Add to basket
              </button>
            </div>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <div className={styles.shopPlaceholderItem}>placeholder_item_4</div>
            placeholder_item_4 £{item4.cost}
            <div className={styles.shopAddToBasketButtons}>
              <select
                name="size"
                id="size"
                onChange={(e) => setShopItem4Size(e.target.value)}
              >
                <option value="" disabled selected={shopItem4Size === ""}>
                  Size
                </option>
                <option value="XL" selected={shopItem4Size === "XL"}>
                  XL
                </option>
                <option value="L" selected={shopItem4Size === "L"}>
                  L
                </option>
                <option value="M" selected={shopItem4Size === "M"}>
                  M
                </option>
                <option value="S" selected={shopItem4Size === "S"}>
                  S
                </option>
                <option value="XS" selected={shopItem4Size === "XS"}>
                  XS
                </option>
              </select>
              <button
                type="submit"
                onClick={() => handleAddToBasket(4, item4.cost)}
                disabled={shopItem4Size === ""}
              >
                Add to basket
              </button>
            </div>
